...
public class StringIntegerParser implements IntegerParser {
    private static final StringIntegerParser INSTANCE = new StringIntegerParser();

    public static StringIntegerParser getInstance() {
        return INSTANCE;
    }

    private StringIntegerParser() {
    }
